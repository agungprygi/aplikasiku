...
<body>
    <div class="form-group">
        ...
        <p>Kepada <span>:</span> Kepala Unit Manajemen Intern</p>
        <p>Dari   <span>:</span> Tim Perumusan dan Implementasi KEKDA</p>
        <p style="text-align: justify; text-indent: 0.5in;">Dalam rangka pelaksanaan kegiatan Fungsi Pelaksanaan dan Pengembangan UMKM, KI dan Syariah pada tanggal 18 s/d 29 Februari 2024. Dengan ini kami mohon bantuan Saudara agar dapat menugaskan driver beserta unit kendaraan dengan rincian sebagai berikut.</p>
        ...
        <table>
                ...
                <tr>
                    <td scope="col" class="text-center"  style="width: 300px; text-center">Plt. Deputi Kepala Perwakilan</td>
                    <td scope="col" class="text-center"  style="width: 500px">Analis,</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td scope="col" class="text-center"  style="width: 300px"><u>Erlangga Febrianno</u></td>
                    <td scope="col" class="text-center"  style="width: 500px"><u>Ardiansyah Eddi Putra</u></td>
                </tr>
                <tr>
                    <td scope="col" class="text-center"  style="width: 300px">Manajer</td>
                    <td scope="col" class="text-center"  style="width: 500px">Manajer</td>
                </tr>
        </table>
    </div>
</body>
